...
int main() {
	...
	cout << "Over a period of " << numMonth << ", " << totalInches << " inches of rain fell." << endl;
	cout << "Average monthly rainfall for the period is " << setprecision(3) << fixed << average << " inches." << endl;
